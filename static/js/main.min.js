...
jQuery(document).ready(function(e){function t(){var t=e(window).scrollTop();e(".item-parallax-1").css("transform","translateY("+-.08*t+"px)"),e(".item-parallax-2").css("transform","translateY("+-.15*t+"px)"),e(".item-parallax-3").css("transform","translateY("+-.2*t+"px)"),e(".item-parallax-4").css("transform","translateY("+-.3*t+"px)"),e(".item-parallax-5").css("transform","translateY("+-.45*t+"px)")}try{e(".hamburguer").click(function(){e(".navigation-toggle, .menu-overlay, .menu--primary, .header--menu, .menu--social, .header--main, .header--menu---wrap").toggleClass("active")})}catch(e){console.log(e)}/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)&&e(".menu--primary > ul > li > a").click(function(t){e(this).parent().siblings().find("ul").removeClass("open-submenu"),e(this).parent().find("ul").length>0&&(t.stopPropagation(),t.preventDefault(),e(this).parent().find("ul").first().toggleClass("open-submenu"))});try{var a=e(".header");a.offset().top,a.height();e(window).scroll(function(){e(window).scrollTop()>250?a.addClass("sticky"):a.removeClass("sticky")})}catch(e){console.log(e)}try{e.easing.easeInOutExpo=function(e,t,a,o,n){return 0==t?a:t==n?a+o:(t/=n/2)<1?o/2*Math.pow(2,10*(t-1))+a:o/2*(2-Math.pow(2,-10*--t))+a},e("a.anchor").click(function(t){return e("html, body").stop().animate({scrollTop:e(e(this.hash)).offset().top},800,"easeInOutExpo"),!1})}catch(e){console.log(e)}try{new Swiper(".card-slider--single",{centeredSlides:!0,speed:1e3,pagination:{el:".swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})}catch(e){console.log(e)}try{e("[data-fancybox]").fancybox({buttons:["close"]})}catch(e){console.log(e)}e("section a").each(function(){e(this).mousemove(function(e){var t=e.pageX-e.target.offsetLeft,a=e.pageY-e.target.offsetTop;e.target.style.setProperty("--x",t+"px"),e.target.style.setProperty("--y",a+"px")})}),e(".item-banner--fullscreen---downbutton a").click(function(t){e("html, body").animate({scrollTop:e(this.hash).offset().top-80},900),t.preventDefault()}),e(".home main section:nth-of-type(2)").attr("id","under-the-fold"),e(window).scroll(function(e){t()});try{e(".open-modal").click(function(t){openModal=e(this).attr("href"),e(".modal-overlay, "+openModal).addClass("active"),t.preventDefault()}),e(".close-modal, .modal-overlay").click(function(t){e(".modal-overlay,"+openModal).removeClass("active")})}catch(e){console.log(e)}});
